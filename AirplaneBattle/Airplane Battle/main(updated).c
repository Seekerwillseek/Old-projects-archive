...
{
    //player
    player.sprite = LoadTexture("R:\Whatsapp shared\Airplane Battle(zip)\Airplane Battle\res\player1.png /res/player1.png");
    player.speed = 3.0f;
    ...
    *player_bullet = LoadTexture("R:\Whatsapp shared\Airplane Battle(zip)\Airplane Battle\res\player_bullet.png/res/player_bullet.png");
    for(int i=0; i<num_bullets; ++i)
    {
    ...
    //misc
    *bullet_speed = 7.0f;
    *grass = LoadTexture("R:\Whatsapp shared\Airplane Battle(zip)\Airplane Battle\res\grass.png/res/grass.png");

    //health_levelup
    health.sprite = LoadTexture("R:\Whatsapp shared\Airplane Battle(zip)\Airplane Battle\res\health.png/res/health.png");
    health.pos.x = 100;
    health.pos.y = 100;
    health.size = 1.5f;
    health.to_show = false;
    ...
    //enemy
    *enemy_bullet = LoadTexture("R:\Whatsapp shared\Airplane Battle(zip)\Airplane Battle\res\enemy_bullet.png/res/enemy_bullet.png");
    for(int i=0; i<num_enemies; ++i)
    {
        enemy[i].sprite = LoadTexture( TextFormat("R:\Whatsapp shared\Airplane Battle(zip)\Airplane Battle\res\enemy0.png/res/enemy%d.png",i) );
